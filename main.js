...
module.exports = "<p [hidden]=\"forgot\">\n  book works!\n</p>\n\n<input [(ngModel)]=\"name\" #txtName/><br/>\n\n<span [ngStyle]=\"name.length %2==0 ? evenStyle : ollStyle \">Your name is: {{ name }}</span>\n\n"
...
var BookComponent = /** @class */ (function () {
    function BookComponent() {
        ...
        this.ollStyle = { color: 'yellow', fontSize: '30px' };
        this.imageUrl = "https://i-vnexpress.vnecdn.net/2018/05/22/11039127-1526963604_500x300.jpg";
        this.forgot = false;
    }
...
module.exports = "<h1><ng-content select=\".name\"></ng-content></h1>\n<span><ng-content select=\".age\"></ng-content></span>\n\n\n"
...
var PersonComponent = /** @class */ (function () {
    ...
    PersonComponent.prototype.addEvent = function () {
        this.myClick.emit(true);
    };
    PersonComponent.prototype.subEvent = function () {
...
var StructComponent = /** @class */ (function () {
    ...
    StructComponent.prototype.changeValue = function (event) {
        if (event) {
...
module.exports = __webpack_require__(/*! /Users/viet/Documents/ionic/angular/angular-tour-of-heroes/src/main.ts */"./src/main.ts");
